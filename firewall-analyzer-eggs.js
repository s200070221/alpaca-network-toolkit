...
// 彩蛋：分析完成後觸發條件型彩蛋（2026-09 從 firewall-analyzer-app.js 搬移，純函式只吃
// parsed 參數+tr()/showEggToast()，不碰 DOM/PARSED 閉包狀態，零 closure 風險；呼叫端
// app.js 內 `checkAnalyzeEggs(PARSED)` 靠全域作用域鏈找到這裡的定義，不需要改呼叫寫法）
